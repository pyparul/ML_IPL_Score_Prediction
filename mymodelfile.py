...
class MyModel:
    ...
    def predict(self, test_data):
        ...
        inning_one = inning_one.reindex(range(36)).ffill()
        inning_two = inning_two.reindex(range(36)).ffill()

        prediction_inning_one = ((self.model.predict(inning_one).sum()))
        prediction_inning_two = ((self.model.predict(inning_two).sum()))
